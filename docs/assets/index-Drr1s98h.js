...
void main() {
	...
	`}function Kh(i){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===Yr||l===qr,h=l===ni||l===ii;if(c||h)if(a.isRenderTargetTexture&&a.needsPMREMUpdate===!0){a.needsPMREMUpdate=!1;let f=e.get(a);return t===null&&(t=new _a(i)),f=c?t.fromEquirectangular(a,f):t.fromCubemap(a,f),e.set(a,f),f.texture}else{if(e.has(a))return e.get(a).texture;{const f=a.image;if(c&&f&&f.height>0||h&&f&&r(f)){t===null&&(t=new _a(i));const p=c?t.fromEquirectangular(a):t.fromCubemap(a);return e.set(a,p),a.addEventListener("dispose",s),p.texture}else return null}}}return a}function r(a){let l=0;const c=6;for(let h=0;h<c;h++)a[h]!==void 0&&l++;return l===c}function s(a){const l=a.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function $h(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(n){n.isWebGL2?(t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance")):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(n){const r=t(n);return r===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function Jh(i,e,t,n){const r={},s=new WeakMap;function o(f){const p=f.target;p.index!==null&&e.remove(p.index);for(const g in p.attributes)e.remove(p.attributes[g]);for(const g in p.morphAttributes){const M=p.morphAttributes[g];for(let d=0,u=M.length;d<u;d++)e.remove(M[d])}p.removeEventListener("dispose",o),delete r[p.id];const m=s.get(p);m&&(e.remove(m),s.delete(p)),n.releaseStatesOfGeometry(p),p.isInstancedBufferGeometry===!0&&delete p._maxInstanceCount,t.memory.geometries--}function a(f,p){return r[p.id]===!0||(p.addEventListener("dispose",o),r[p.id]=!0,t.memory.geometries++),p}function l(f){const p=f.attributes;for(const g in p)e.update(p[g],i.ARRAY_BUFFER);const m=f.morphAttributes;for(const g in m){const M=m[g];for(let d=0,u=M.length;d<u;d++)e.update(M[d],i.ARRAY_BUFFER)}}function c(f){const p=[],m=f.index,g=f.attributes.position;let M=0;if(m!==null){const w=m.array;M=m.version;for(let S=0,A=w.length;S<A;S+=3){const L=w[S+0],C=w[S+1],b=w[S+2];p.push(L,C,C,b,b,L)}}else if(g!==void 0){const w=g.array;M=g.version;for(let S=0,A=w.length/3-1;S<A;S+=3){const L=S+0,C=S+1,b=S+2;p.push(L,C,C,b,b,L)}}else return;const d=new(Ja(p)?oo:ao)(p,1);d.version=M;const u=s.get(f);u&&e.remove(u),s.set(f,d)}function h(f){const p=s.get(f);if(p){const m=f.index;m!==null&&p.version<m.version&&c(f)}else c(f);return s.get(f)}return{get:a,update:l,getWireframeAttribute:h}}function Qh(i,e,t,n){const r=n.isWebGL2;let s;function o(m){s=m}let a,l;function c(m){a=m.type,l=m.bytesPerElement}function h(m,g){i.drawElements(s,g,a,m*l),t.update(g,s,1)}function f(m,g,M){if(M===0)return;let d,u;if(r)d=i,u="drawElementsInstanced";else if(d=e.get("ANGLE_instanced_arrays"),u="drawElementsInstancedANGLE",d===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}d[u](s,g,a,m*l,M),t.update(g,s,M)}function p(m,g,M){if(M===0)return;const d=e.get("WEBGL_multi_draw");if(d===null)for(let u=0;u<M;u++)this.render(m[u]/l,g[u]);else{d.multiDrawElementsWEBGL(s,g,0,a,m,0,M);let u=0;for(let w=0;w<M;w++)u+=g[w];t.update(u,s,1)}}this.setMode=o,this.setIndex=c,this.render=h,this.renderInstances=f,this.renderMultiDraw=p}function ed(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(s/3);break;case i.LINES:t.lines+=a*(s/2);break;case i.LINE_STRIP:t.lines+=a*(s-1);break;case i.LINE_LOOP:t.lines+=a*s;break;case i.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function td(i,e){return i[0]-e[0]}function nd(i,e){return Math.abs(e[1])-Math.abs(i[1])}function id(i,e,t){const n={},r=new Float32Array(8),s=new WeakMap,o=new ut,a=[];for(let c=0;c<8;c++)a[c]=[c,0];function l(c,h,f){const p=c.morphTargetInfluences;if(e.isWebGL2===!0){const g=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,M=g!==void 0?g.length:0;let d=s.get(h);if(d===void 0||d.count!==M){let J=function(){T.dispose(),s.delete(h),h.removeEventListener("dispose",J)};var m=J;d!==void 0&&d.texture.dispose();const u=h.morphAttributes.position!==void 0,w=h.morphAttributes.normal!==void 0,S=h.morphAttributes.color!==void 0,A=h.morphAttributes.position||[],L=h.morphAttributes.normal||[],C=h.morphAttributes.color||[];let b=0;u===!0&&(b=1),w===!0&&(b=2),S===!0&&(b=3);let z=h.attributes.position.count*b,ie=1;z>e.maxTextureSize&&(ie=Math.ceil(z/e.maxTextureSize),z=e.maxTextureSize);const v=new Float32Array(z*ie*4*M),T=new to(v,z,ie,M);T.type=qt,T.needsUpdate=!0;const te=b*4;for(let P=0;P<M;P++){const W=A[P],V=L[P],j=C[P],k=z*ie*4*P;for(let q=0;q<W.count;q++){const Z=q*te;u===!0&&(o.fromBufferAttribute(W,q),v[k+Z+0]=o.x,v[k+Z+1]=o.y,v[k+Z+2]=o.z,v[k+Z+3]=0),w===!0&&(o.fromBufferAttribute(V,q),v[k+Z+4]=o.x,v[k+Z+5]=o.y,v[k+Z+6]=o.z,v[k+Z+7]=0),S===!0&&(o.fromBufferAttribute(j,q),v[k+Z+8]=o.x,v[k+Z+9]=o.y,v[k+Z+10]=o.z,v[k+Z+11]=j.itemSize===4?o.w:1)}}d={count:M,texture:T,size:new we(z,ie)},s.set(h,d),h.addEventListener("dispose",J)}if(c.isInstancedMesh===!0&&c.morphTexture!==null)f.getUniforms().setValue(i,"morphTexture",c.morphTexture,t);else{let u=0;for(let S=0;S<p.length;S++)u+=p[S];const w=h.morphTargetsRelative?1:1-u;f.getUniforms().setValue(i,"morphTargetBaseInfluence",w),f.getUniforms().setValue(i,"morphTargetInfluences",p)}f.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),f.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}else{const g=p===void 0?0:p.length;let M=n[h.id];if(M===void 0||M.length!==g){M=[];for(let A=0;A<g;A++)M[A]=[A,0];n[h.id]=M}for(let A=0;A<g;A++){const L=M[A];L[0]=A,L[1]=p[A]}M.sort(nd);for(let A=0;A<8;A++)A<g&&M[A][1]?(a[A][0]=M[A][0],a[A][1]=M[A][1]):(a[A][0]=Number.MAX_SAFE_INTEGER,a[A][1]=0);a.sort(td);const d=h.morphAttributes.position,u=h.morphAttributes.normal;let w=0;for(let A=0;A<8;A++){const L=a[A],C=L[0],b=L[1];C!==Number.MAX_SAFE_INTEGER&&b?(d&&h.getAttribute("morphTarget"+A)!==d[C]&&h.setAttribute("morphTarget"+A,d[C]),u&&h.getAttribute("morphNormal"+A)!==u[C]&&h.setAttribute("morphNormal"+A,u[C]),r[A]=b,w+=b):(d&&h.hasAttribute("morphTarget"+A)===!0&&h.deleteAttribute("morphTarget"+A),u&&h.hasAttribute("morphNormal"+A)===!0&&h.deleteAttribute("morphNormal"+A),r[A]=0)}const S=h.morphTargetsRelative?1:1-w;f.getUniforms().setValue(i,"morphTargetBaseInfluence",S),f.getUniforms().setValue(i,"morphTargetInfluences",r)}}return{update:l}}function rd(i,e,t,n){let r=new WeakMap;function s(l){const c=n.render.frame,h=l.geometry,f=e.get(l,h);if(r.get(f)!==c&&(e.update(f),r.set(f,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),r.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const p=l.skeleton;r.get(p)!==c&&(p.update(),r.set(p,c))}return f}function o(){r=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:o}}class po extends St{constructor(e,t,n,r,s,o,a,l,c,h){if(h=h!==void 0?h:Rn,h!==Rn&&h!==ri)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===Rn&&(n=an),n===void 0&&h===ri&&(n=wn),super(null,r,s,o,a,l,h,n,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:_t,this.minFilter=l!==void 0?l:_t,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const mo=new St,_o=new po(1,1);_o.compareFunction=$a;const go=new to,vo=new zl,xo=new uo,Ma=[],Sa=[],Ea=new Float32Array(16),ya=new Float32Array(9),Ta=new Float32Array(4);function ai(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=Ma[r];if(s===void 0&&(s=new Float32Array(r),Ma[r]=s),e!==0){n.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(s,a)}return s}function at(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function ot(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function sr(i,e){let t=Sa[e];t===void 0&&(t=new Int32Array(e),Sa[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function sd(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function ad(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(at(t,e))return;i.uniform2fv(this.addr,e),ot(t,e)}}function od(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(at(t,e))return;i.uniform3fv(this.addr,e),ot(t,e)}}function ld(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(at(t,e))return;i.uniform4fv(this.addr,e),ot(t,e)}}function cd(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(at(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),ot(t,e)}else{if(at(t,n))return;Ta.set(n),i.uniformMatrix2fv(this.addr,!1,Ta),ot(t,n)}}function ud(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(at(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),ot(t,e)}else{if(at(t,n))return;ya.set(n),i.uniformMatrix3fv(this.addr,!1,ya),ot(t,n)}}function hd(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(at(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),ot(t,e)}else{if(at(t,n))return;Ea.set(n),i.uniformMatrix4fv(this.addr,!1,Ea),ot(t,n)}}function dd(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function fd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(at(t,e))return;i.uniform2iv(this.addr,e),ot(t,e)}}function pd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(at(t,e))return;i.uniform3iv(this.addr,e),ot(t,e)}}function md(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(at(t,e))return;i.uniform4iv(this.addr,e),ot(t,e)}}function _d(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function gd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(at(t,e))return;i.uniform2uiv(this.addr,e),ot(t,e)}}function vd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(at(t,e))return;i.uniform3uiv(this.addr,e),ot(t,e)}}function xd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(at(t,e))return;i.uniform4uiv(this.addr,e),ot(t,e)}}function Md(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);const s=this.type===i.SAMPLER_2D_SHADOW?_o:mo;t.setTexture2D(e||s,r)}function Sd(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||vo,r)}function Ed(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||xo,r)}function yd(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||go,r)}function Td(i){switch(i){case 5126:return sd;case 35664:return ad;case 35665:return od;case 35666:return ld;case 35674:return cd;case 35675:return ud;case 35676:return hd;case 5124:case 35670:return dd;case 35667:case 35671:return fd;case 35668:case 35672:return pd;case 35669:case 35673:return md;case 5125:return _d;case 36294:return gd;case 36295:return vd;case 36296:return xd;case 35678:case 36198:case 36298:case 36306:case 35682:return Md;case 35679:case 36299:case 36307:return Sd;case 35680:case 36300:case 36308:case 36293:return Ed;case 36289:case 36303:case 36311:case 36292:return yd}}function Ad(i,e){i.uniform1fv(this.addr,e)}function bd(i,e){const t=ai(e,this.size,2);i.uniform2fv(this.addr,t)}function wd(i,e){const t=ai(e,this.size,3);i.uniform3fv(this.addr,t)}function Rd(i,e){const t=ai(e,this.size,4);i.uniform4fv(this.addr,t)}function Cd(i,e){const t=ai(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Pd(i,e){const t=ai(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Ld(i,e){const t=ai(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function Dd(i,e){i.uniform1iv(this.addr,e)}function Ud(i,e){i.uniform2iv(this.addr,e)}function Id(i,e){i.uniform3iv(this.addr,e)}function Nd(i,e){i.uniform4iv(this.addr,e)}function Fd(i,e){i.uniform1uiv(this.addr,e)}function Od(i,e){i.uniform2uiv(this.addr,e)}function Bd(i,e){i.uniform3uiv(this.addr,e)}function zd(i,e){i.uniform4uiv(this.addr,e)}function Gd(i,e,t){const n=this.cache,r=e.length,s=sr(t,r);at(n,s)||(i.uniform1iv(this.addr,s),ot(n,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||mo,s[o])}function Hd(i,e,t){const n=this.cache,r=e.length,s=sr(t,r);at(n,s)||(i.uniform1iv(this.addr,s),ot(n,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||vo,s[o])}function Vd(i,e,t){const n=this.cache,r=e.length,s=sr(t,r);at(n,s)||(i.uniform1iv(this.addr,s),ot(n,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||xo,s[o])}function kd(i,e,t){const n=this.cache,r=e.length,s=sr(t,r);at(n,s)||(i.uniform1iv(this.addr,s),ot(n,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||go,s[o])}function Wd(i){switch(i){case 5126:return Ad;case 35664:return bd;case 35665:return wd;case 35666:return Rd;case 35674:return Cd;case 35675:return Pd;case 35676:return Ld;case 5124:case 35670:return Dd;case 35667:case 35671:return Ud;case 35668:case 35672:return Id;case 35669:case 35673:return Nd;case 5125:return Fd;case 36294:return Od;case 36295:return Bd;case 36296:return zd;case 35678:case 36198:case 36298:case 36306:case 35682:return Gd;case 35679:case 36299:case 36307:return Hd;case 35680:case 36300:case 36308:case 36293:return Vd;case 36289:case 36303:case 36311:case 36292:return kd}}class Xd{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Td(t.type)}}class Yd{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Wd(t.type)}}class qd{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],n)}}}const Gr=/(\w+)(\])?(\[|\.)?/g;function Aa(i,e){i.seq.push(e),i.map[e.id]=e}function jd(i,e,t){const n=i.name,r=n.length;for(Gr.lastIndex=0;;){const s=Gr.exec(n),o=Gr.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===r){Aa(t,c===void 0?new Xd(a,i,e):new Yd(a,i,e));break}else{let f=t.map[a];f===void 0&&(f=new qd(a),Aa(t,f)),t=f}}}class ji{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);jd(s,o,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&n.push(o)}return n}}function ba(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const Zd=37297;let Kd=0;function $d(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}function Jd(i){const e=qe.getPrimaries(qe.workingColorSpace),t=qe.getPrimaries(i);let n;switch(e===t?n="":e===Ji&&t===$i?n="LinearDisplayP3ToLinearSRGB":e===$i&&t===Ji&&(n="LinearSRGBToLinearDisplayP3"),i){case hn:case ir:return[n,"LinearTransferOETF"];case Nt:case ns:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function wa(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=i.getShaderInfoLog(e).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+$d(i.getShaderSource(e),o)}else return r}function Qd(i,e){const t=Jd(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function ef(i,e){let t;switch(e){case sl:t="Linear";break;case al:t="Reinhard";break;case ol:t="OptimizedCineon";break;case ll:t="ACESFilmic";break;case ul:t="AgX";break;case hl:t="Neutral";break;case cl:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function tf(i){return[i.extensionDerivatives||i.envMapCubeUVHeight||i.bumpMap||i.normalMapTangentSpace||i.clearcoatNormalMap||i.flatShading||i.alphaToCoverage||i.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(i.extensionFragDepth||i.logarithmicDepthBuffer)&&i.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",i.extensionDrawBuffers&&i.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(i.extensionShaderTextureLOD||i.envMap||i.transmission)&&i.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(ei).join(`
...
#define LOW_PRECISION`),e}function hf(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Ha?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Uo?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Xt&&(e="SHADOWMAP_TYPE_VSM"),e}function df(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ni:case ii:e="ENVMAP_TYPE_CUBE";break;case nr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function ff(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ii:e="ENVMAP_MODE_REFRACTION";break}return e}function pf(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Va:e="ENVMAP_BLENDING_MULTIPLY";break;case il:e="ENVMAP_BLENDING_MIX";break;case rl:e="ENVMAP_BLENDING_ADD";break}return e}function mf(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function _f(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=hf(t),c=df(t),h=ff(t),f=pf(t),p=mf(t),m=t.isWebGL2?"":tf(t),g=nf(t),M=rf(s),d=r.createProgram();let u,w,S=t.glslVersion?"#version "+t.glslVersion+`
...
`,tp=8,Ga=328972;class np{constructor(e){this._canvas=e,this._frameCount=0,this._splatMesh=null,this._rawPositions=null,this._rawColors=null,this._rawScales=null,this._splatCount=0,this._sortedPos=null,this._sortedCol=null,this._sortedScl=null,this._sortedIdx=null,this._distances=null,this._mouseNDC=new we(0,0),this._mouseOver=!1,this._interacting=0,this._clock=new Kf,this._initThree(),this._initControls(),this._initMouse(),this._bindResize(),this._animate()}loadSplats({positions:e,colors:t,scales:n,count:r}){this._splatMesh&&(this._scene.remove(this._splatMesh),this._splatMesh.geometry.dispose(),this._splatMesh.material.dispose(),this._splatMesh=null),this._rawPositions=e.slice(),this._rawColors=t.slice(),this._rawScales=n.slice(),this._splatCount=r,this._sortedPos=new Float32Array(r*3),this._sortedCol=new Float32Array(r*4),this._sortedScl=new Float32Array(r),this._sortedIdx=new Int32Array(r),this._distances=new Float32Array(r);for(let s=0;s<r;s++)this._sortedIdx[s]=s;this._sortSplats(),this._splatMesh=this._buildMesh(this._sortedPos.slice(0,r*3),this._sortedCol.slice(0,r*4),this._sortedScl.slice(0,r),r),this._scene.add(this._splatMesh)}resetCamera(){this._camera.position.set(0,0,2.2),this._camera.lookAt(0,0,0),this._controls.target.set(0,0,0),this._controls.update()}_initThree(){const e=new Mo({canvas:this._canvas,antialias:!0});e.setPixelRatio(Math.min(window.devicePixelRatio,2)),e.setSize(window.innerWidth,window.innerHeight),e.setClearColor(Ga,1),this._renderer=e,this._scene=new jf,this._scene.fog=new ss(Ga,.15),this._camera=new Rt(55,window.innerWidth/window.innerHeight,.005,80),this._camera.position.set(0,0,2.2)}_initControls(){const e=new Jf(this._camera,this._canvas);e.enableDamping=!0,e.dampingFactor=.06,e.minDistance=.05,e.maxDistance=30,e.enablePan=!0,e.screenSpacePanning=!0,this._controls=e}_initMouse(){const e=this._canvas;e.addEventListener("mousemove",t=>{const n=e.getBoundingClientRect();this._mouseNDC.x=(t.clientX-n.left)/n.width*2-1,this._mouseNDC.y=-((t.clientY-n.top)/n.height)*2+1,this._mouseOver=!0}),e.addEventListener("mouseleave",()=>{this._mouseOver=!1}),e.addEventListener("mouseenter",()=>{this._mouseOver=!0}),e.addEventListener("touchmove",t=>{t.preventDefault();const n=e.getBoundingClientRect(),r=t.touches[0];this._mouseNDC.x=(r.clientX-n.left)/n.width*2-1,this._mouseNDC.y=-((r.clientY-n.top)/n.height)*2+1,this._mouseOver=!0},{passive:!1}),e.addEventListener("touchend",()=>{this._mouseOver=!1})}_bindResize(){window.addEventListener("resize",()=>{const e=window.innerWidth,t=window.innerHeight;this._camera.aspect=e/t,this._camera.updateProjectionMatrix(),this._renderer.setSize(e,t)})}_buildMesh(e,t,n,r){const s=new xi(1,1),o=new Zf;o.index=s.index,o.attributes.position=s.attributes.position,o.setAttribute("aPos",new Vr(e,3)),o.setAttribute("aColor",new Vr(t,4)),o.setAttribute("aScale",new Vr(n,1)),o.instanceCount=r;const a=new Kt({uniforms:{uMouse:{value:new we(0,0)},uInteracting:{value:0},uTime:{value:0}},vertexShader:Qf,fragmentShader:ep,transparent:!0,depthWrite:!1,depthTest:!0,blending:bn});return s.dispose(),new Bt(o,a)}_sortSplats(){const e=this._splatCount,t=this._rawPositions,n=this._camera.position;for(let p=0;p<e;p++){const m=t[p*3]-n.x,g=t[p*3+1]-n.y,M=t[p*3+2]-n.z;this._distances[p]=m*m+g*g+M*M}const r=this._distances;this._sortedIdx.sort((p,m)=>r[m]-r[p]);const s=this._sortedPos,o=this._sortedCol,a=this._sortedScl,l=this._rawPositions,c=this._rawColors,h=this._rawScales,f=this._sortedIdx;for(let p=0;p<e;p++){const m=f[p];s[p*3]=l[m*3],s[p*3+1]=l[m*3+1],s[p*3+2]=l[m*3+2],o[p*4]=c[m*4],o[p*4+1]=c[m*4+1],o[p*4+2]=c[m*4+2],o[p*4+3]=c[m*4+3],a[p]=h[m]}}_pushSortedToGPU(){if(!this._splatMesh)return;const e=this._splatMesh.geometry,t=this._splatCount,n=e.attributes.aPos,r=e.attributes.aColor,s=e.attributes.aScale;n.array.set(this._sortedPos.subarray(0,t*3)),r.array.set(this._sortedCol.subarray(0,t*4)),s.array.set(this._sortedScl.subarray(0,t)),n.needsUpdate=r.needsUpdate=s.needsUpdate=!0}_animate(){if(requestAnimationFrame(()=>this._animate()),this._controls.update(),this._frameCount++,this._mouseOver?this._interacting=Math.min(1,this._interacting+.09):this._interacting=Math.max(0,this._interacting-.055),this._splatMesh){const e=this._splatMesh.material.uniforms;e.uMouse.value.copy(this._mouseNDC),e.uInteracting.value=this._interacting,e.uTime.value=this._clock.getElapsedTime()}this._splatMesh&&this._frameCount%tp===0&&(this._sortSplats(),this._pushSortedToGPU()),this._renderer.render(this._scene,this._camera)}}const as=document.getElementById("upload-screen"),So=document.getElementById("processing-screen"),Eo=document.getElementById("viewer-screen"),ip=document.getElementById("canvas"),Dn=document.getElementById("drop-zone"),yo=document.getElementById("file-input"),rp=document.getElementById("demo-btn"),sp=document.getElementById("progress-bar"),ap=document.getElementById("progress-label"),op=document.getElementById("splat-count"),lp=document.getElementById("back-btn"),cp=new Co,up=new Po;let Yi=null;async function os(i){tr(So),await Jn(),pi(5,"Analysing image…"),await Jn(),pi(15,"Estimating depth…"),await Jn();const e=await hp(()=>cp.estimate(i));pi(60,"Generating Gaussian splats…"),await Jn();const t=up.generate(i,e,{step:1});pi(80,`Uploading ${t.count.toLocaleString()} splats to GPU…`),await Jn(),Yi||(Yi=new np(ip)),Yi.loadSplats(t),Yi.resetCamera(),op.textContent=t.count.toLocaleString()+" splats",pi(100,"Done"),await Jn(),tr(Eo)}function hp(i){return new Promise(e=>setTimeout(()=>e(i()),0))}function pi(i,e){sp.style.width=i+"%",ap.textContent=e}function tr(i){for(const e of[as,So,Eo])e.classList.toggle("active",e===i)}async function Jn(){return new Promise(i=>requestAnimationFrame(i))}function To(i){return new Promise((e,t)=>{const n=new Image,r=URL.createObjectURL(i);n.onload=()=>{const o=Math.min(1,380/Math.max(n.width,n.height)),a=Math.round(n.width*o),l=Math.round(n.height*o),c=document.createElement("canvas");c.width=a,c.height=l;const h=c.getContext("2d");h.drawImage(n,0,0,a,l),e(h.getImageData(0,0,a,l)),URL.revokeObjectURL(r)},n.onerror=t,n.src=r})}function dp(){const e=document.createElement("canvas");e.width=300,e.height=300;const t=e.getContext("2d"),n=t.createLinearGradient(0,0,0,300);n.addColorStop(0,"#0d1b6e"),n.addColorStop(.5,"#1a3a8a"),n.addColorStop(1,"#e08040"),t.fillStyle=n,t.fillRect(0,0,300,300);const r=t.createRadialGradient(300*.5,300*.52,4,300*.5,300*.52,90);r.addColorStop(0,"rgba(255,240,80,0.95)"),r.addColorStop(.3,"rgba(255,160,20,0.6)"),r.addColorStop(1,"rgba(255,100,0,0)"),t.fillStyle=r,t.fillRect(0,0,300,300);const s=t.createLinearGradient(0,300*.52,0,300);s.addColorStop(0,"#4a3020"),s.addColorStop(1,"#1a0a05"),t.fillStyle=s,t.fillRect(0,300*.52,300,300*.48),t.fillStyle="white";for(let o=0;o<80;o++){const a=Math.random()*300,l=Math.random()*300*.45,c=Math.random()*1.2+.3;t.beginPath(),t.arc(a,l,c,0,Math.PI*2),t.fill()}t.fillStyle="#0d0a18",t.beginPath(),t.moveTo(0,300*.62);for(let o=0;o<=300;o+=300/12){const a=156-Math.sin(o*.07)*40-Math.random()*20;t.lineTo(o,a)}return t.lineTo(300,300),t.lineTo(0,300),t.closePath(),t.fill(),t.getImageData(0,0,300,300)}yo.addEventListener("change",async i=>{const e=i.target.files[0];e&&os(await To(e))});Dn.addEventListener("dragover",i=>{i.preventDefault(),Dn.classList.add("drag-over")});Dn.addEventListener("dragleave",()=>{Dn.classList.remove("drag-over")});Dn.addEventListener("drop",async i=>{i.preventDefault(),Dn.classList.remove("drag-over");const e=i.dataTransfer.files[0];e&&e.type.startsWith("image/")&&os(await To(e))});Dn.addEventListener("click",()=>yo.click());rp.addEventListener("click",()=>{os(dp())});lp.addEventListener("click",()=>{tr(as)});tr(as);
